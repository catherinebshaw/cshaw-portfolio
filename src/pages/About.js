...
function About() {
  const [profile] = useState({
    ...
    info3: "Now I am transitioning to full-stack web development. I am rolling up my sleeves and using technology to help organizations of all sizes solve complex, and sometimes simple, business problems.",

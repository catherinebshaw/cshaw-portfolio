...
function About() {
  const [profile] = useState({
    ...
    info3: "Now I am transitioning to full-stack web development. I now have technical programming skills in HTML, CSS, JavaScript, Bootstrap, Node JS, MySQL, MongoDB, Express and ReactJs. I am excited to roll up my sleeves and use this technical knowledge to help organizations of all sizes solve complex, and sometimes simple, business problems.",
